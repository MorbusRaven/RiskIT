<header>
	<div class="navbar navbar-expand-lg navbar-expand-md">
		<div class="logo_div">
			<a class="navbar-brand" href="index.php"><h1>Risk Assistant</h1></a>
		</div>
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item mr-4"><a class="nav-link active" href="index.php">Home</a></li>
				<li class="nav-item mr-4"><a class="nav-link active" href="projectCreation.php">Project Creation</a></li>
